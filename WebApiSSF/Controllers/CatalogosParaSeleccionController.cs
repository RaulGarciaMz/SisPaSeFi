...
namespace WebApiSSF.Controllers
{
    ...
    public class CatalogosParaSeleccionController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="opcion">Nombre de la opción para catálogo ("RSF", "TipoPatrullaje", "TipoVehiculo", "ClasificacionIncidencia", "Niveles", "ConceptosAfectacion", "RegionesSDN", "ResultadoPatrullaje", "EstadosDelPais", "MunicipiosEstado", "ProcesosResponsables", "GerenciaDivision", "TipoDocumento", "EstadosPatrullaje", "ApoyoPatrullaje", "InstalacionesDeComandancia", "NivelRiesgo")</param>
        /// <param name="usuario">Nombre del usuario (usuario_nom) que realiza la operación</param>
        /// <returns></returns>
        [HttpGet]
        [Produces(MediaTypeNames.Application.Json)]
