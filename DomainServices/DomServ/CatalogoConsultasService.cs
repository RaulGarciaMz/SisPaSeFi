...
namespace DomainServices.DomServ
{
    public class CatalogoConsultasService : ICatalogosConsultaService
    {
        ...
        public async Task<List<CatalogoGenerico>> ObtenerEstadosIncidenciaAsync(string usuario)
        {
            var cat = new List<CatalogoGenerico>();
            var user = await _user.ObtenerUsuarioConfiguradorPorNombreAsync(usuario);
            ...
            if (user != null)
            {
                var clas = await _repo.ObtenerEstadosIncidenciaAsync();

                foreach (var c in clas)
                {
                    var row = new CatalogoGenerico()
                    {
                        Id = c.IdEstadoIncidencia,
                        Descripcion = c.DescripcionEstado
                    };
        ...
        public async Task<List<CatalogoGenerico>> ObtenerComandanciasDeUnUsuarioAsync(int idUsuario, string usuario)
        {
            var cat = new List<CatalogoGenerico>();
            var user = await _user.ObtenerUsuarioConfiguradorPorNombreAsync(usuario);
        ...
        public async Task<List<CatalogoGenerico>> ObtenerGruposCorreoDeUnUsuarioAsync(int idUsuario, string usuario)
        {
            var cat = new List<CatalogoGenerico>();
            var user = await _user.ObtenerUsuarioConfiguradorPorNombreAsync(usuario);
            ...
            if (user != null)
            {
                var clas = await _repo.ObtenerGruposCorreoDeUnUsuarioAsync(idUsuario);

                foreach (var c in clas)
                {
                    var row = new CatalogoGenerico()
                    {
                        Id = c.IdGrupoCorreo.Value,
                        Descripcion = ""
                    };
        ...
        public async Task<List<CatalogoGenerico>> ObtenerRolesDeUnUsuarioAsync(int idUsuario, string usuario)
        {
            var cat = new List<CatalogoGenerico>();
            var user = await _user.ObtenerUsuarioConfiguradorPorNombreAsync(usuario);
            ...
            if (user != null)
            {
                var clas = await _repo.ObtenerRolesDeUnUsuarioAsync(idUsuario);
        ...
        public async Task<List<CatalogoGenerico>> ObtenerMenusDeRolAsync(int idRol, string usuario)
        {
            var cat = new List<CatalogoGenerico>();
            var user = await _user.ObtenerUsuarioConfiguradorPorNombreAsync(usuario);
            ...
            if (user != null)
            {
                var clas = await _repo.ObtenerMenusDeRolAsync(idRol);
                ...
                foreach (var c in clas)
                {
                    ...
                    {
                        Id = c.IdMenu,
                        Descripcion = c.Navegar.Value.ToString()
                    };
